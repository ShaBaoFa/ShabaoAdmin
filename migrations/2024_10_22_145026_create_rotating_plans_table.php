...
return new class extends Migration {
    ...
    {
        Schema::create('rotating_plans', function (Blueprint $table) {
            $table->bigIncrements('id')->comment('ID');
            $table->addColumn('bigInteger', 'theme_id', ['comment' => '主题ID'])->index()->nullable();
    ...
    {
        Schema::dropIfExists('rotating_plans');
    }
};
